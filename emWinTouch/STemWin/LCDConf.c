...
#include "../STemWin/GUIDRV_FlexColor.h"
#include "../STemWin/ST7789-parallel.h"
...
static void LcdWriteReg(U8 Data) {
	parallelWriteDC0(Data); // ... TBD by user
	//printf ("Command: %X\n", Data);
}
...
static void LcdWriteData(U8 Data) {
	parallelWriteDC1(Data);  // ... TBD by user
	//printf ("Data: %X\n", Data);
}
...
static void LcdWriteDataMultiple(U8 * pData, int NumItems) {
	parallelMultiWriteDC1(pData, NumItems); // ... TBD by user
...
static void LcdReadDataMultiple(U8 * pData, int NumItems) {
	parallelMultiReadDC1(pData, NumItems); // ... TBD by user
  }
