...
#include "../STemWin/GUI_ConfDefaults.h"
#include "../STemWin/GUI_Type.h"      /* Needed because of typedefs only */
#include "../STemWin/WM_GUI.h"       /* Some functions needed by GUI routines */
